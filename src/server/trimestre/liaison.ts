 ...
 *
 * POURQUOI SI PEU DE TABLEAUX SONT LIÉS. Le canevas régional demande souvent un
 * détail que le SID ne collecte pas : il veut les abattages bovins par
 * catégorie — taurillon, génisse, castré, taureau, vache, veau — là où le
 * mensuel ne saisit qu'un total par arrondissement. Ces tableaux restent vides
 * tant que la collecte n'aura pas été étendue ; c'est un constat, pas un
 * renoncement, et docs/COUVERTURE.md en tient le compte.
 *
...
/** Toutes les liaisons établies à ce jour. */
