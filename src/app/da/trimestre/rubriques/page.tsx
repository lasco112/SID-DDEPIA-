    ...
    <AppShell allowedRoles={["DA"]}>
      <div className="max-w-4xl">
        ...
        <p className="mt-1 text-sm text-ink-muted">
          Les zones d&apos;analyse du canevas, pour votre arrondissement. Ce que vous écrivez ici est repris
          tel quel dans le document produit — vous n&apos;avez plus à le retaper dans Word.
        </p>
        <div className="mt-6">
